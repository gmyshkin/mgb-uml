...
// THE FIX: Deleted #include "tikzit.h" to stop the UI ghost file crash!
#include "util.h"
#include <QPainter>
#include <QFont>
#include <QFontMetrics>

// Define the scale and font locally for the plugin
...
QPainterPath UseCaseNodeItem::shape() const {
    ...
    QFontMetrics fm(MGB_LABEL_FONT); // REPLACED
...
void UseCaseNodeItem::paint(QPainter *painter, const QStyleOptionGraphicsItem *, QWidget *) {
    ...
    painter->setFont(MGB_LABEL_FONT); // REPLACED
...
QPainterPath ClassNodeItem::shape() const {
    ...
    QFontMetrics fm(MGB_LABEL_FONT); // REPLACED
    QFont boldFont = MGB_LABEL_FONT; boldFont.setBold(true); // REPLACED
...
void ClassNodeItem::paint(QPainter *painter, const QStyleOptionGraphicsItem *, QWidget *) {
    ...
    QFont titleFont = MGB_LABEL_FONT; titleFont.setBold(true); // REPLACED
