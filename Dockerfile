...
WORKDIR /src
# 1. Copy with trailing slashes (Forces directory copy)
COPY docs/ /src/docs/

# 2. THE TRIPWIRE: List the files.
# If index.html is missing, this command will print an error in your terminal 
